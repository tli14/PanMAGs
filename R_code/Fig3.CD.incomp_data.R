...
mod_data <- read.table(file = "R_code/Fig2.frag_incomp/incomp_model.txt",  sep = '\t', header = TRUE)
equation_data <- read.table(file = "R_code/Fig2.frag_incomp/incomp_equation.txt",  sep = '\t', header = TRUE)
