...
final_dist = createSkewDist(mean=int(desired_mean), sd=desired_sd, skew=desired_skew, size=100)
final_dist = np.round(final_dist)
random.shuffle(final_dist)
final_dist = final_dist.astype(int)
